...
#
biom add-metadata -i ../$name/closed/clustered-table/feature-table.biom -o $../$name/closed/clustered-table/feature-table-tax.biom --observation-metadata-fp ../classifiers/silva119/taxonomy_99_7_levels.txt --observation-header OTUID,taxonomy --sc-separated taxonomy
#
