...
wget https://data.qiime2.org/distro/core/qiime2-2018.11-py35-osx-conda.yml       # Downloads the .yaml for QIIME2 
conda env create -n qiime2-2018.11 --file qiime2-2018.11-py35-osx-conda.yml       # Creates the QIIME2 environment
rm qiime2-2018.11-py35-osx-conda.yml                                            # Deletes the QIIME2 .yaml to be tidy 
