...
wget https://data.qiime2.org/2019.4/common/silva-132-99-515-806-nb-classifier.qza -O classifiers/illumina_16S/silva-132-99-515-806-nb-classifier.qza
wget https://data.qiime2.org/2019.4/common/silva-132-99-nb-classifier.qza -O classifiers/iontorrent_16S/silva-132-99-nb-classifier.qza
echo -e "\nFinished!\n"
